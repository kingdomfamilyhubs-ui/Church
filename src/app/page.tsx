    ...
    <div className="flex flex-col bg-black overflow-x-hidden">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl mb-6 leading-[1.1] font-black tracking-tighter uppercase italic animate-in fade-in zoom-in-95 duration-1000 text-white">
            GROWING <span className="text-primary">IN FAITH</span> <br/> GLOBAL CHURCH
          </h1>
          <p className="text-sm md:text-lg text-muted-foreground mb-10 max-w-3xl mx-auto font-bold italic leading-relaxed uppercase tracking-[0.2em] animate-in fade-in slide-in-from-bottom-4 duration-1000">
            "Transforming non extinct into existence" <br/>
            <span className="text-xs font-light tracking-widest opacity-70">— Romans 4:17</span>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <Button asChild size="lg" className="bg-primary text-black font-black h-12 px-10 text-[10px] rounded-none hover:bg-white transition-all uppercase tracking-[0.2em]">
              <Link href="/about">Our Vision</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="h-12 px-10 text-[10px] rounded-none border-white/20 text-white hover:bg-white hover:text-black uppercase tracking-[0.2em]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="group space-y-6 text-center md:text-left border-l-0 md:border-l border-primary/20 md:pl-8 transition-all hover:border-primary">
                ...
                <h3 className="text-xl font-black italic text-white leading-tight">{pillar.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-3xl md:text-5xl font-black italic leading-[1.1] text-white uppercase">Transforming <br/> <span className="text-primary underline decoration-primary/30 underline-offset-4">Non Extinct</span> <br/> Into Existence</h2>
              <p className="text-sm text-muted-foreground leading-relaxed uppercase tracking-wider font-light">
                Growing In Faith Global Church is dedicated to uncovering the deep mysteries of the Kingdom. Through precision, power, and the accurate Word of God, we bring into existence that which was hidden.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 py-6 border-y border-white/5">
                <div className="space-y-2">
                  <h4 className="text-3xl text-primary font-black italic">20M+</h4>
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">Global Partnership</p>
                </div>
                <div className="space-y-2">
                  <h4 className="text-3xl text-primary font-black italic">100+</h4>
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">Global Branches</p>
                </div>
              </div>
              <Button asChild variant="outline" className="border-primary text-primary hover:bg-primary hover:text-black rounded-none h-12 px-8 text-[10px] font-black uppercase tracking-[0.3em] transition-all">
        ...
        {[
          ...
          <Link key={idx} href={item.href} className="group relative aspect-square md:aspect-[4/5] overflow-hidden border border-white/5">
            ...
            <div className="absolute bottom-8 left-8 z-20">
              <h4 className="text-xl font-black italic text-white group-hover:text-primary transition-colors leading-none mb-2">{item.label}</h4>
      ...
      <section className="py-32 bg-primary text-black text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none flex items-center justify-center">
          <h2 className="text-[15vw] font-black italic opacity-20 select-none">FAITH</h2>
        </div>
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h2 className="text-4xl md:text-6xl font-black mb-8 italic leading-[1.1] tracking-tighter uppercase">THE SUPERNATURAL AWAITS YOU</h2>
          <p className="text-sm md:text-lg mb-12 font-black uppercase tracking-[0.3em] max-w-2xl mx-auto leading-relaxed italic">
            "Transforming non extinct into existence"
          </p>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <Button asChild size="lg" className="bg-black text-white hover:bg-zinc-900 rounded-none h-14 px-12 text-[10px] font-black uppercase tracking-[0.3em] shadow-xl">
              <Link href="/contact">Find A Branch</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-black text-black hover:bg-black hover:text-white rounded-none h-14 px-12 text-[10px] font-black uppercase tracking-[0.3em] transition-all">
