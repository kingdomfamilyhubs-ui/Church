    ...
    <div className="flex flex-col bg-black overflow-x-hidden">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-7xl mb-6 leading-[1.1] font-black tracking-tighter uppercase italic animate-in fade-in zoom-in-95 duration-1000 text-white">
            GROWING <span className="text-primary">IN FAITH</span> <br/> GLOBAL CHURCH
          </h1>
          <p className="text-base md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto font-light leading-relaxed uppercase tracking-[0.2em] animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <Button asChild size="lg" className="bg-primary text-black font-black h-14 px-10 text-[10px] rounded-none hover:bg-white transition-all uppercase tracking-[0.2em]">
              <Link href="/about">Our Vision</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="h-14 px-10 text-[10px] rounded-none border-white/20 text-white hover:bg-white hover:text-black uppercase tracking-[0.2em]">
      ...
      <section className="py-24 bg-zinc-950 border-y border-white/5 relative overflow-hidden">
        <div className="absolute -right-20 top-20 opacity-5 pointer-events-none">
          <Zap className="h-96 w-96 text-primary rotate-12" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="group space-y-6 text-center md:text-left border-l-0 md:border-l border-primary/20 md:pl-8 transition-all hover:border-primary">
                <pillar.icon className="h-12 w-12 text-primary mx-auto md:mx-0 group-hover:scale-110 transition-transform" />
                <h3 className="text-2xl font-black italic text-white leading-tight">{pillar.title}</h3>
                <p className="text-muted-foreground leading-relaxed text-[10px] font-bold uppercase tracking-[0.2em]">
                  {pillar.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative aspect-[4/5] overflow-hidden grayscale group hover:grayscale-0 transition-all duration-1000 border border-white/10 p-1.5 bg-zinc-900">
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-4xl md:text-6xl font-black italic leading-[1.1] text-white">Raising a <br/> <span className="text-primary underline decoration-primary/30 underline-offset-4">Supernatural</span> <br/> Generation</h2>
              <p className="text-sm text-muted-foreground leading-relaxed uppercase tracking-wider font-light text-justify">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 py-6 border-y border-white/5">
                <div className="space-y-2">
                  <h4 className="text-4xl text-primary font-black italic">20M+</h4>
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">Global Partnership</p>
                </div>
                <div className="space-y-2">
                  <h4 className="text-4xl text-primary font-black italic">100+</h4>
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">Global Branches</p>
                </div>
              </div>
              <Button asChild variant="outline" className="border-primary text-primary hover:bg-primary hover:text-black rounded-none h-14 px-8 text-[10px] font-black uppercase tracking-[0.3em] transition-all">
        ...
        {[
          ...
          <Link key={idx} href={item.href} className="group relative aspect-square md:aspect-[4/5] overflow-hidden border border-white/5">
            ...
            <div className="absolute bottom-8 left-8 z-20">
              <h4 className="text-2xl font-black italic text-white group-hover:text-primary transition-colors leading-none mb-2">{item.label}</h4>
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground">{item.sub}</p>
            </div>
          </Link>
        ))}
      </section>
      ...
      <section className="py-40 bg-primary text-black text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none flex items-center justify-center">
          <h2 className="text-[20vw] font-black italic opacity-20 select-none">FAITH</h2>
        </div>
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h2 className="text-5xl md:text-7xl font-black mb-8 italic leading-[1.1] tracking-tighter">THE SUPERNATURAL <br/> AWAITS YOU</h2>
          <p className="text-base md:text-xl mb-12 font-black uppercase tracking-[0.3em] max-w-2xl mx-auto leading-relaxed">
            Experience the move of God at any of our global branches or join us live online.
          </p>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <Button asChild size="lg" className="bg-black text-white hover:bg-zinc-900 rounded-none h-16 px-12 text-[10px] font-black uppercase tracking-[0.3em] shadow-xl">
              <Link href="/contact">Find A Branch</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-black text-black hover:bg-black hover:text-white rounded-none h-16 px-12 text-[10px] font-black uppercase tracking-[0.3em] transition-all">
